<!-- [00riddle00] newest specs can be found in https://github.com/ethereum/eth2.0-specs/blob/dev/specs/simple-serialize.md
this file here is used to make references to line/col numbers in specs
this specs file itself will be referenced everywhere as [specs:line=...,{col=...}{:line=...,{col=...}}]
